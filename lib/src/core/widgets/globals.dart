...
class Globals {
  ...
  static double formFieldIconSize = 20.0;
  static double formFieldFontLabelSize = 12.0;
  static double formFieldFloatingLabelFontSize = 16.0;
  static double formFieldFontSize = 14.0;
  static double formFieldBorderRadius = 4.0;
